...
const ImproveCV = () => {
  ...
  // Apply AI improvements to CV
  const applyImprovements = () => {
    toast.info("Improvements will be applied to your CV");
    // Here you would implement the actual application of improvements
    closeResponseModal();
  };
              ...
              <div className="border-t border-gray-200 bg-gray-50 px-6 py-4 sticky bottom-0 z-10">
                <div className="flex flex-wrap gap-3 justify-end">
                  ...
                  <motion.button
                    ...
                    className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-sm hover:shadow-md transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-sm"
                  >
