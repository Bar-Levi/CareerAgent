...
const JobListingCard = ({ onJobSelect, jobListing, setShowModal, showNotification, setCurrentOpenConversationId
  ...
  return <div className="flex flex-col border border-gray-300 rounded-lg shadow-lg bg-gradient-to-r from-white to-gray-200 p-6 max-w-xl hover:shadow-xl transition-shadow duration-300">
  ...
  <div className="flex flex-wrap items-center justify-between">
    ...
    <button className="px-4 py-2 font-semibold rounded bg-gradient-to-tr from-orange-300 to-orange-600 text-white hover:from-orange-400 hover:to-orange-700 hover:shadow-lg">
      Talk with Chatbot
    </button>
