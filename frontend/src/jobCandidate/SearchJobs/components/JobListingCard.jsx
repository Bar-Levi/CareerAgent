          ...
          <div className="relative bg-white rounded-xl shadow-xl border border-gray-200 p-5 w-80 max-w-[90vw] max-h-[80vh] overflow-auto z-50">
            ...
            <div>
              <ul className="list-none pl-0 space-y-3">
                {matchedData?.jobRole?.length > 0 && relevancePoints?.matchedJobRolePoints > 0 && (
                ...
                {matchedData?.jobType?.length > 0 && parseInt(matchedData.jobType[0].split(',')[1]) > 0 && (
                ...
                {matchedData?.securityClearance !== null && relevancePoints?.matchedSecurityClearancePoints > 0 && (
                ...
                {matchedData?.education?.length > 0 && relevancePoints?.matchedEducationPoints > 0 && (
                ...
                {matchedData?.workExperience?.length > 0 && relevancePoints?.matchedWorkExperiencePoints > 0 && (
                ...
                {matchedData?.skills?.length >= 3 && relevancePoints?.matchedSkillPoints > 0 && (
