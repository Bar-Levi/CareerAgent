...
const Features = () => {
  return (
    <section className="w-full py-20 md:py-28 bg-black relative min-h-screen flex flex-col items-center justify-center" id="features">
      ...
      <div className="relative z-10 w-full max-w-[95%] xl:max-w-[90%] mx-auto flex flex-col">
        <motion.h2
          className="text-5xl md:text-6xl text-center font-bold mb-16 md:mb-20 text-gray-200 font-display"
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-16 px-4 md:px-8">
...
const Card = ({ title, icon, children, description, image, index = 1 }) => {
  ...
  return (
    <motion.div
      ...
      className="border border-white/[0.2] group/canvas-card flex flex-col items-center justify-start w-full h-[50vh] sm:h-[55vh] lg:h-[60vh] p-6 relative rounded-[1.5rem] overflow-hidden transition-all duration-500 hover:border-white/[0.5] hover:shadow-[0_0_30px_rgba(255,255,255,0.15)]"
    >
      <motion.div 
