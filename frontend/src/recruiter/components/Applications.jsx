...
const Applications = ({ applications = [], setSelectedConversationId, setSelectedJobListing, setSelectedCandidate, setTitle, setViewMode}) => {
                ...
                >
                  <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6">
                    ...
                    <div className="flex-grow">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-500 mb-2">
                            Applied for: <span className="font-medium text-blue-600">{app.jobTitle}</span>
                          </p>
                          <p className="text-xs text-gray-400 mb-3">
                            Applied on: {new Date(app.applicationDate || app.date).toLocaleDateString()}
                          </p>
                        </div>

                        <div 
                          className={`px-3 py-1 text-xs font-medium rounded-full ${statusColors[app.status] || 'bg-blue-100 text-blue-800'}`}
                        >
                          {app.status}
                        </div>
                      </div>
                      ...
                      {/* Chat Button */}
                      <button
                        className="mt-4 px-6 py-2 bg-gradient-to-r from-blue-500 to-blue-700 text-white text-sm font-semibold rounded-full shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
